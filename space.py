...
class Grid:
    ...
    def tester(self):
         print("WANNNNNNNNNNNNNNNNNNNNNNNNNNNNN")   
    ...
    def get_eliptical_neighborhood(
        self,
        pos: Coordinate,
        moore: bool,
        include_center: bool = False,
        ...
        """
        cache_key = (pos, moore, include_center, 1) #JTK made this 1?
        ...
        if neighborhood is None:
            ...
            x, y = pos
            for dy in range(-radius_b, radius_b + 1):
                for dx in range(-radius_c, radius_a + 1):
